...
class MenuSub extends JFrame implements ActionListener {
    ...
    private Button SGame = new Button("Project Neptune");
    ...
    private void MainMenu(){
        ...
        //Start Game
        SGame.setBounds(ButtonXPos_Left,ButtonYPos,
                ButtonWidth, ButtonHeight);
        ButtonYPos=(ButtonYPos+ButtonYOffset+ButtonHeight);

        //Program options
        BOptions.setBounds(ButtonXPos_Left, ButtonYPos,
                ButtonWidth, ButtonHeight);
        ButtonYPos=(ButtonYPos+ButtonYOffset+ButtonHeight);

        //About Page
        BAbout.setBounds(ButtonXPos_Left, ButtonYPos,
                ButtonWidth, ButtonHeight);
        ButtonYPos=(ButtonYPos+ButtonYOffset+ButtonHeight);

        //Credits
        BCredit.setBounds(ButtonXPos_Left, ButtonYPos,
                ButtonWidth, ButtonHeight);
        ButtonYPos=(ButtonYPos+ButtonYOffset+ButtonHeight);

        //Exit Program
        BQuit.setBounds(ButtonXPos_Left, ButtonYPos,
                ButtonWidth, ButtonHeight);
        ButtonYPos=(ButtonYPos+ButtonYOffset+ButtonHeight);
